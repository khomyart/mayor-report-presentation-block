...
const templatesConfig = {
    templateList: [
        {
            name: 'Привіт, друже',
            content: '<div class="block-elem-template field-item" i-name="block" widthmultiplier="102" heightmultiplier="102" borderwidthmultiplier="0" borderradiusmultiplier="0" fontsizemultiplier="2" paddingmultiplier="0.2" marginbottommultiplier="0.2" canchor="-50%,-50%" locktype="movement" newly-created="false" cy="49.6094%" cx="49.6513%" style="width: 913.92px; height: 652.8px; border-width: 0px; border-radius: 0px; transform: translate(-50%, -50%); font-size: 17.92px; padding: 2px; z-index: 101; left: 49.2188%; top: 49.0625%; display: block; transition: all 0s ease-in-out 0s; background-image: linear-gradient(0deg, rgba(239, 37, 37, 0.55) 10%, rgb(38, 96, 232) 92%);" i-is-selectable="true"></div><a class="text-elem-template field-item" i-name="href" widthmultiplier="auto" heightmultiplier="auto" borderwidthmultiplier="0" borderradiusmultiplier="0" fontsizemultiplier="2.6" paddingmultiplier="0.2" marginbottommultiplier="0.2" canchor="0%,0%" locktype="none" newly-created="false" cy="86.9141%" cx="6.4156%" style="outline: none; text-decoration: none; cursor: pointer; color: black; width: auto; height: auto; border-width: 0px; border-radius: 0px; transform: translate(0%, 0%); font-size: 23.296px; padding: 2px; z-index: 102; left: 6.36161%; top: 85.3125%; display: block; transition: all 0s ease-in-out 0s; background-image: linear-gradient(90deg, rgba(255, 255, 255, 0) 10%, rgba(255, 255, 255, 0) 90%);" i-is-selectable="true" href="https://lutskrada.gov.ua"><p marginbottommultiplier="0.2" style="margin-bottom: 1.28px;"><span style="color:hsl(0,0%,100%);"><strong>lutskrada.gov.ua</strong></span></p></a><div class="text-elem-template field-item" i-name="text" widthmultiplier="auto" heightmultiplier="auto" borderwidthmultiplier="0" borderradiusmultiplier="0" fontsizemultiplier="5.8" paddingmultiplier="0.2" marginbottommultiplier="0.2" canchor="0%,0%" locktype="none" newly-created="false" cy="6.6406%" cx="6.6946%" style="width: auto; height: auto; border-width: 0px; border-radius: 0px; transform: translate(0%, 0%); font-size: 51.968px; padding: 2px; z-index: 103; left: 6.69643%; top: 6.5625%; display: block; transition: all 0s ease-in-out 0s; background-image: linear-gradient(90deg, rgba(255, 255, 255, 0) 10%, rgba(255, 255, 255, 0) 90%);" i-is-selectable="true"><p marginbottommultiplier="0.2" style="margin-bottom: 1.28px;"><span style="color:hsl(0, 0%, 100%);">Привіт, друже</span></p><p marginbottommultiplier="0.2" style="margin-bottom: 1.28px;"><span style="color:hsl(0, 0%, 100%);">з вчора…</span></p><p marginbottommultiplier="0.2" style="margin-bottom: 1.28px;"><span style="color:hsl(0, 0%, 100%);">давно не бачились</span></p></div><div class="block-elem-template field-item" i-name="block" widthmultiplier="52" heightmultiplier="1" borderwidthmultiplier="0" borderradiusmultiplier="0" fontsizemultiplier="2" paddingmultiplier="0.2" marginbottommultiplier="0.2" canchor="0%,0%" locktype="none" newly-created="false" cy="45.3125%" cx="6.9735%" style="width: 465.92px; height: 6.4px; border-width: 0px; border-radius: 0px; transform: translate(0%, 0%); font-size: 17.92px; padding: 2px; z-index: 104; left: 6.91964%; top: 44.375%; display: block; transition: all 0s ease-in-out 0s; background-image: linear-gradient(90deg, rgb(249, 253, 13) 10%, rgb(44, 110, 242) 90%); background-color: rgba(228, 211, 33, 0);" i-is-selectable="true"></div><div class="block-elem-template field-item selected-item" i-name="block" widthmultiplier="17" heightmultiplier="100" borderwidthmultiplier="0" borderradiusmultiplier="0" fontsizemultiplier="2" paddingmultiplier="0.2" marginbottommultiplier="0.2" canchor="-100%,-100%" locktype="movement" newly-created="false" cy="100.3906%" cx="100.5579%" style="width: 152.32px; height: 640px; border-width: 0px; border-radius: 0px; transform: translate(-100%, -100%); font-size: 17.92px; padding: 2px; z-index: 105; left: 99.1071%; top: 98.4375%; display: block; transition: all 0s ease-in-out 0s; background-image: linear-gradient(0deg, rgba(254, 22, 22, 0.52) 10%, rgba(255, 255, 255, 0) 90%); background-color: rgba(189, 106, 97, 0);" i-is-selectable="true"></div>',
        },
        {
            name: 'тест з індексу',
